        ...
        if ($row = mysqli_fetch_assoc($resultl)){
            ...
            if ($device_mode == 1) {
                ...
                if (isset($_GET['action']) && $_GET['action'] == 'register') {
                    // Handle card registration logic here
                    // Retrieve the card UID from the GET parameters
                    $card_uid = $_GET['card_uid'];
                
                    // Add code to insert the card UID into your database
                    // You may need to create a new table for card registrations
                    // For example: INSERT INTO registered_cards (card_uid) VALUES ('$card_uid')
